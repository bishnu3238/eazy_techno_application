...
class FirebasePhoneVerificationFailure implements AuthFailure {
  const FirebasePhoneVerificationFailure([
    this.message = 'An unknown exception occurred.',
  ]);

  factory FirebasePhoneVerificationFailure.fromCode(String code) {
    switch (code) {
      case 'invalid-phone-number':
        return const FirebasePhoneVerificationFailure(
